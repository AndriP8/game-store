        ...
        <div className="position-relative" data-aos="zoom-in">
          ...
          <div className="card left-card position-absolute border-0">
            <div className="d-flex align-items-center mb-16 gap-3">
              <Image src="/img/Header-2.png" className="rounded-pill" height={40} width={40} alt="user-avatar-main-banner" />
              <div>
            ...
            <div className="d-flex gap-2">
              <Image src="/icon/star.svg" width={22} height={22} alt="icon-star" />
              <Image src="/icon/star.svg" width={22} height={22} alt="icon-star" />
              <Image src="/icon/star.svg" width={22} height={22} alt="icon-star" />
              <Image src="/icon/star.svg" width={22} height={22} alt="icon-star" />
              <Image src="/icon/star.svg" width={22} height={22} alt="icon-star" />
